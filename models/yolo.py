...
from models.EffQAFPN import QARepVGGB
...
from models.slim import VoVGSCSP
...
class NADH(nn.Module):
    def __init__(self, ch=256, nc=80, anchors=()):
        ...
        self.iou_convs1 = Conv(256, 256, 3, 1, 1)
        self.iou_convs2 = Conv(256, 128, 3, 1, 1)
        self.iou_convs3 = Conv(128, 64, 3, 1, 1)

        self.obj_convs1 = DWConv(256, 256, 3, 1, 1)
    ...
    def forward(self, x):
        ...
        x2 = self.iou_convs3(self.iou_convs2(self.iou_convs1(x)))
        x21 = self.reg_preds(x2)
...
class BaseModel(nn.Module):
    ...
    def _apply(self, fn):
        ...
        if isinstance(m, (Detect, Segment, DecoupledDet, LADHDetect)):
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
                Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, SimSPPF, DWConv, MixConv2d, Focus, CrossConv,
        ...
        elif m in [CBH, ES_Bottleneck, ShuffleNetV2Block, Conv_maxpool]:
            c1, c2 = ch[f], args[0]
        ...
        #         # c2 = make_divisible(c2 * gw, 8) 如果下面这句报错，那就使用这一句
        ...
        elif m in [RepVGGBlock, RepBlock, SimConv, Transpose, QARepVGGB]:
            c1, c2 = ch[f], args[0]
            if c2 != no:  # if not output
                c2 = make_divisible(c2 * gw, 8)
            args = [c1, c2, *args[1:]]
