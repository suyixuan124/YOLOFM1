...
#--------------YOLOv5代码实践 + Focal-EIoU / Focal-SIoU / Focal-DIoU / Focal-CIoU / Focal-GIoU 等大全集
def bbox_iou(box1, box2, x1y1x2y2=True, GIoU=False, DIoU=False, CIoU=False, EIoU=False, SIoU=False,  FocalLoss_= 'none', eps=1e-7):
    ...
    #------------YOLOv5代码实践 + Focal-EIoU / Focal-SIoU / Focal-DIoU / Focal-CIoU / Focal-GIoU 等大全集结尾部分
...
'''
# SIoU、EIoU、GIoU 函数改进部分 bbox_iou
